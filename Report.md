...
-	Administrators struggle with opaque metrics for staffing high risk cases, theatre allocation and perrfomance and workload on the staff.
...
## Solution
The registry was initialised in 2024. I used the mock data from the exported csv for this, and started by analyzing the raw file. The file was too large and unprocessed. Static reports lacked fast querying, interactive filtering, and statistical benchmarking. Base R plots offered no interactivity. 
...
I deployed to shinyapps.io after suppressing non critical warnings. Iterative testing checked filter consistency across tabs like monthly CCS trends by manufacturer dropdown.
